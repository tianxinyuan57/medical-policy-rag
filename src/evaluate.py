...
TEST_CASES = [
    ...
    },
    {
        ...
        "expected_points": [
            "药品所含成份与国家药品标准规定的成份不符属于假药",
            "以非药品冒充药品或者以他种药品冒充此种药品属于假药",
            "变质的药品属于假药",
            "药品所标明的适应症或者功能主治超出规定范围属于假药",
        ],
        "type": "精确检索",
    },
    {
    ...
    },
    {
        ...
        "expected_points": [
            "申请人应当具有完全民事行为能力",
            "在中等职业学校或高等学校完成规定的护理专业课程学习并取得毕业证书",
            "通过卫生主管部门组织的护士执业资格考试",
            "符合规定的健康标准",
        ],
        "type": "精确检索",
    ...
    # ---- 类型 2：需要理解/推理的题 ----
    {
        ...
        "expected_points": [
            "患者有权查阅复制门诊病历和住院志",
            "患者有权查阅复制体温单医嘱单化验单检验报告",
            "患者有权查阅复制医学影像检查资料和手术同意书",
            "医疗机构应当在患者要求时提供病历复制服务",
        ],
        "type": "理解推理",
    },
    {
